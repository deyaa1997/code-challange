  ...
  return (
    <section className={styles["user-section"]}>
      <Image
        ...
        width={100}
        height={100}
        style={{ borderRadius: "50%", marginInlineEnd: "36px" }}
        loading="lazy"
      ...
      <div className={styles["user-main"]}>
        <h1 className={styles["user-name"]} id="user-name">
          {userData.name}
        </h1>

        <section className={styles["user-links"]}>
          <Link
            href={userData.profileLink}
            target="_blank"
            rel="noopener noreferrer"
          >
            <div className={styles["user-link-container"]} id="user-website">
              <p>GitHub </p>
              <svg
                height="20"
                width="20"
                xmlns="http://www.w3.org/2000/svg"
                className={styles["user-link-icon"]}
              >
                <g fill="#4b6a9b">
